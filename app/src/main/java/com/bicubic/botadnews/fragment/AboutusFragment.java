...
public class AboutusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        about_webview = (WebView)rootView.findViewById(R.id.about_webview);

        about_webview.loadUrl("http://www.bicubicstudios.com/botadnews/Botad/index.php/api/about_us");
