...
public class DownloadTask extends AsyncTask<String, Integer, String> {
    ...
    protected void onPreExecute() {
        ...
        mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                Toast.makeText(context, R.string.download_in_background, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected String doInBackground(String... str) {
        ...
        try {
            ...
            String sdcard_path = Environment.getExternalStorageDirectory().getPath();
            File PapersDiractory;
            if (Type.contains("image")) {
                // create a File object for the parent directory
                PapersDiractory = new File(sdcard_path + "/Botad News/Images");
            } else {
                // create a File object for the parent directory
                PapersDiractory = new File(sdcard_path + "/Botad News/Videos");
            }

            // have the object build the directory structure, if needed.
            PapersDiractory.mkdirs();
            Log.d("Path ------ ", " " + PapersDiractory);
